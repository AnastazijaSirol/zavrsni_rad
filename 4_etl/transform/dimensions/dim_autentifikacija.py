...
# Stvaranje kategorija metoda autentifikacije
def get_authentication_method_category(method):
    secure_methods = ["Biometric", "Otp"]
    insecure_methods = ["Password", "Pin"]

    if method in secure_methods:
        return "Secure"
    elif method in insecure_methods:
        return "Insecure"
    else:
        return "Unknown"
